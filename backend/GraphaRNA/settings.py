"""
Django settings for GraphaRNA project.
...
SETUP_BASE_DIR= os.getenv("SETUP_BASE_DIR","error")
...
WSGI_APPLICATION = "GraphaRNA.wsgi.application"
...
ENGINE_REQUEST_MAX_RETRIES = 5
ENGINE_REQUEST_RETRY_DELAY = 30
